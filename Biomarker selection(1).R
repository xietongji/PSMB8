...
for (Omics in c("SNV","CNAmp","CNDel","5mCMet","mRNA")) {
  ...
  for (Algorithms in c("CIBERSORT","quanTIseq")) {
    ...
    for(gene in rownames(Groupingdata)){
...
StatSigResults=fourcellsResults[(fourcellsResults$p<0.05 & fourcellsResults$fdr<0.25),]
LIST=list()
...
fourcellsResultsnew$diff=ifelse(fourcellsResultsnew$p<0.05 &
                                  fourcellsResultsnew$fdr<0.25,fourcellsResultsnew$diff,0)
...
fourcellsResultsCIBERSORTnew$Tcell=as.numeric(fourcellsResultsCIBERSORTnew$CD8T)-as.numeric(fourcellsResultsCIBERSORTnew$Treg)
fourcellsResultsCIBERSORTnew$Macrophage=as.numeric(fourcellsResultsCIBERSORTnew$M1)-as.numeric(fourcellsResultsCIBERSORTnew$M2)
fourcellsResultsquanTIseqnew$Tcell=as.numeric(fourcellsResultsquanTIseqnew$CD8T)-as.numeric(fourcellsResultsquanTIseqnew$Treg)
fourcellsResultsquanTIseqnew$Macrophage=as.numeric(fourcellsResultsquanTIseqnew$M1)-as.numeric(fourcellsResultsquanTIseqnew$M2)
CIBERSORTLIST=list()
quanTIseqLIST=list()
for (setname in header3) {
  CIBERSORTLIST[[paste0("T+M+_",setname)]]=fourcellsResultsCIBERSORTnew[fourcellsResultsCIBERSORTnew$gene %in% c(LIST3[[paste0("TypeA_",setname)]],LIST3[[paste0("TypeB_",setname)]],LIST3[[paste0("TypeC_",setname)]],LIST3[[paste0("TypeD_",setname)]]) & 
                                                                          ...
                                                                          fourcellsResultsCIBERSORTnew$Tcell>0 &
                                                                          fourcellsResultsCIBERSORTnew$Macrophage>0,"gene"]
  CIBERSORTLIST[[paste0("T+M-_",setname)]]=fourcellsResultsCIBERSORTnew[fourcellsResultsCIBERSORTnew$gene %in% c(LIST3[[paste0("TypeA_",setname)]],LIST3[[paste0("TypeB_",setname)]],LIST3[[paste0("TypeC_",setname)]],LIST3[[paste0("TypeD_",setname)]]) & 
                                                                          fourcellsResultsCIBERSORTnew$Omics==setname &
                                                                          fourcellsResultsCIBERSORTnew$Tcell>0 &
                                                                          fourcellsResultsCIBERSORTnew$Macrophage<0,"gene"]
  ...
  quanTIseqLIST[[paste0("T+M+_",setname)]]=fourcellsResultsquanTIseqnew[fourcellsResultsquanTIseqnew$gene %in% c(LIST3[[paste0("TypeA_",setname)]],LIST3[[paste0("TypeB_",setname)]],LIST3[[paste0("TypeC_",setname)]],LIST3[[paste0("TypeD_",setname)]]) & 
                                                                          ...
                                                                          fourcellsResultsquanTIseqnew$Tcell>0 &
                                                                          fourcellsResultsquanTIseqnew$Macrophage>0,"gene"]
  quanTIseqLIST[[paste0("T+M-_",setname)]]=fourcellsResultsquanTIseqnew[fourcellsResultsquanTIseqnew$gene %in% c(LIST3[[paste0("TypeA_",setname)]],LIST3[[paste0("TypeB_",setname)]],LIST3[[paste0("TypeC_",setname)]],LIST3[[paste0("TypeD_",setname)]]) & 
                                                                          fourcellsResultsquanTIseqnew$Omics==setname &
                                                                          fourcellsResultsquanTIseqnew$Tcell>0 &
                                                                          fourcellsResultsquanTIseqnew$Macrophage<0,"gene"]
